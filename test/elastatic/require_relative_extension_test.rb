...
class RequireRelativeExtensionTest < Test::Unit::TestCase
  
  def test_should_be_evident_as_an_extension_to_Object
    assert_kind_of RequireRelativeExtension, Object.new
  end
